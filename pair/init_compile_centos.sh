...
pip install -U --no-cache-dir pip setuptools cython cmake torch_runstats numpy pandas
# apt-get update -y
...
yum install -y zip gcc-gfortran gtest-devel openblas-devel fftw fftw-devel fftw-libs-double
